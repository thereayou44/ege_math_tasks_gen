...
def check_visualization_requirement(category, subcategory):
    ...
    # Check category, subcategory, and keywords
    if (any(cat.lower() in category.lower() for cat in visualization_categories) or
        any(cat.lower() in (subcategory or "").lower() for cat in visualization_subcategories)):
        return True
