...
def test_shapes():
    ...
    paths = []
    paths.append(('Rectangle', generate_geometric_figure('rectangle', rectangle_params, 'tests/static/images/direct_rectangle.png')))
    paths.append(('Parallelogram', generate_geometric_figure('parallelogram', parallelogram_params, 'tests/static/images/direct_parallelogram.png')))
    paths.append(('Trapezoid', generate_geometric_figure('trapezoid', trapezoid_params, 'tests/static/images/direct_trapezoid.png')))
    ...
    plt.tight_layout()
    plt.savefig('tests/static/images/test_shapes_comparison.png')
    print("Test completed. Results saved to tests/static/images/test_shapes_comparison.png")

def test_all_shapes():
    """Генерирует тестовые изображения всех видов фигур с разными параметрами"""
    
    # Создаем директорию для тестовых изображений
    test_dir = 'tests/static/images'
